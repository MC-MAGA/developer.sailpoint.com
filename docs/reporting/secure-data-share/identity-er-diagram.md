...
<MermaidViewer diagram='erDiagram
    ...
    SOURCE {
        ...
        datetime CREATED_DATE "date when the source was created"
        datetime UPDATED_DATE "date when the source was modified"
        datetime DELETED_DATE "date when the object was deleted"
        text DISPLAY_NAME "Human-readable display name of the object"
    ...
    CERTIFICATION_CAMPAIGN {
        ...
        datetime CREATED_DATE "date when the campaign was created"
        datetime UPDATED_DATE "date when the campaign was modified"
    ...
    GOVERNANCE_GROUP {
        text TENANT_ID "Unique Id for an Organization tenant"
        text ID PK "Unique Id for the Governance Group"
        text NAME "Name of the Governance Group"
        datetime CREATED_DATE "date when the governance group was created"
        datetime UPDATED_DATE "date when the governance group was modified"
        text DESCRIPTION "Description of the Governance Group"
        text OWNER_ID "Identity that owns the Governance Group"
        array MEMBERS "List of identity IDs that are members of the Governance Group"
        datetime SYNC_DATE "When the row is last synced"
    }
    ACCESS_MODEL_METADATA_ATTRIBUTE {
        text TENANT_ID "Unique Id for an Organization tenant"
        text ID PK "Unique Id for the Access Model Metadata Attribute"
        text KEY "Key identifier for the attribute"
        text NAME "Name of the attribute"
        boolean MULTISELECT "Whether multiple values can be selected"
        text STATUS "Status of the attribute"
        text TYPE "Type of the attribute"
        array OBJECT_TYPES "List of object types this attribute applies to"
        text DESCRIPTION "Description of the attribute"
        variant ATTRIBUTE_VALUES "List of allowed values for this attribute"
        datetime CREATED_DATE "date when the attribute was created"
    ...
    GOVERNANCE_GROUP }o--|| IDENTITY: "Owned by or members of"
